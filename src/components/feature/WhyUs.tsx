...
const WhyUs: FC = () => {
  return (
    <section className="pb-20 relative">
      <div className="flex place-content-end">
        ...
        >
          ...
          <h2 className="text-4xl font-bold tracking-widest">
            <span className="text-mainRed">D</span>laczego my?
          </h2>
          ...
          <div
            className="flex flex-col text-white bg-red-500 items-center px-2 py-4 absolute bottom-0  translate-y-1/2"
            style={{
      ...
      <div className="relative max-w-screen-2xl mx-auto w-full grid lg:grid-cols-3 lg:gap-10 xl:gap-20 mt-20 px-5 z-20">
        <div className="flex">
          ...
          <div className="flex flex-col items-center p-4 sm:p-8">
            <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold tracking-wider uppercase">
              <span className="text-mainRed">D</span>oświadczony Zespół
            </h3>
        ...
        <div className="flex">
          ...
          <div className="flex flex-col items-center p-4 sm:p-8">
            <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold tracking-wider uppercase">
              <span className="text-mainRed">B</span>ogaty Asortyment Części
            </h3>
            <p className="text-justify mt-4 text-xs sm:text-sm md:text-sm lg:text-base">
        ...
        <div className="flex">
          ...
          <div className="flex flex-col items-center p-4 sm:p-8">
            <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold tracking-wider uppercase">
              <span className="text-mainRed">I</span>ndywidualne Podejście
            </h3>
            <p className="text-justify mt-4 text-xs sm:text-sm md:text-sm lg:text-base">
