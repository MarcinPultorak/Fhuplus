          ...
          >
            ...
            <div className="relative max-w-[calc(1536px-308px)] w-full h-full flex flex-col justify-center items-center px-5 py-8 sm:py-0">
              ...
              <p className="text-xs sm:text-sm md:text-sm lg:text-base max-w-xl mt-5 sm:mt-10 lg:mt-20 text-justify">
                Jesteśmy pasjonatami motoryzacji, gotowymi zaoferować
                kompleksowe usługi naprawcze oraz sprzedaży części do samochodów
                włoskich. Nasza firma wyróżnia się profesjonalizmem,
                doświadczeniem i troską o każdy detal, co sprawia, że jesteśmy
                idealnym wyborem dla Twojego samochodu.
              </p>
              <div
